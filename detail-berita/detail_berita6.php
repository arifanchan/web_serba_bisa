...
$berita = [
    [
        'id' => 1,
        'gambar' => '../assets/img/berita/img-berita6.jpg',
        'name' => 'Begini Keseruan Seminar Penggunaan Alat Masak yang Sehat dan Aman',
        'desc' => 'Seminar ini bertujuan mengajak masyarakat Bali khususnya, untuk hidup sehat. Terutama bagi kalangan dewasa muda yang sering berbelanja di luar. Selain boros, kebersihannya juga tidak terjamin, karena itu hidup sehat dan hemat, bisa kita mulai dari menikmati masakan buatan sendiri dengan alat masak yang terjamin kebersihannya," ungkap Edwin Siswanto, General Manager Sales & Marketing PT Maspion Maxim Division. Selain seminar, acara ini juga diramaikan dengan lomba memasak kreasi mie oleh 31 tim, kuis berhadiah merchandise, bazaar diskon produk Maspion Elektronik, dan juga doorprize puluhan jenis produk dari Maxim.'
    ],
];

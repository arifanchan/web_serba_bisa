...
$berita = [
    [
        'id' => 1,
        'gambar' => '../assets/img/berita/img-berita5.jpg',
        'name' => 'Seminar Pendidikan Indonesia',
        'desc' => 'Dalam kesempatan tersebut, Wakil Ketua Pimpinan Wilayah (PW) IPNU Jatim, M Ishomuddin Haidar menyampaikan, adanya pelantikan berarti IPNU-IPPNU harus siap untuk berjuang mencapai tujuan organisasi. 
        "Dengan adanya pelantikan ini berarti peluit kick of sudah dibunyikan. Itu tandanya rekan dan rekanita yang telah dilantik harus bergerak, berjuang untuk mencapai tujuan. Pelajar NU harus siap menghadapi tantangan kedepannya," ucapnya.
        Sementar itu, Ketua PC IPNU Kota Probolinggo, Muhammad Rizal Ali berpesan kepada jajaran pengurusnya yang telah dilantik supaya terus semangat dan jangan menyerah di tengah jalan.'
    ],
];
